  ...
  return (
    <div className='flex-self-stretch border-md-right border-gray-light bg-white col-md-5 col-lg-4 col-xl-3 px-4 px-md-6 px-lg-7 py-6'>
      ...
      <div className='f4 mb-6'>
        ...
        <div className="mt-4">
          <a target="_blank" href="https://firebasestorage.googleapis.com/v0/b/delish-prod.appspot.com/o/FrederickIge_resume.pdf?alt=media&token=eb1e1f5c-c825-41ca-b6d0-8a7f7e3ad352">Download Resume</a>
        </div>
